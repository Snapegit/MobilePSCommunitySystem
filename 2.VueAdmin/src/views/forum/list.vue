		...
		<div class="app-contain">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button  v-if="!forumChild &&  btnAuth('forum','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">详情</el-button>
			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button type="info" v-if="!forumChild &&  btnAuth('forum','查看')" @click="infoClick(scope.row.id)">详情</el-button>
